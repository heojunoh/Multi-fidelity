...
### RMSE ###
sqrt(mean((predy-apply(x,1,park91b))^2)) # closed form
sqrt(mean((pred2new$mu-apply(x,1,park91b))^2)) # not closed form
sqrt(mean((pred2$mu-apply(x,1,park91b))^2)) # single fidelity
sqrt(mean((mx1-apply(x,1,park91b))^2)) # KOH
