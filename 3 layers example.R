...
# X1 <- matrix(c(X1, maximinLHS(20, 1))) # x^L
# y1 <- fl(X1, l=1)
...
### prediction of original GP with 3-level fidelity ###
fit.GP3 <- GP(X3, y3)
pred3 <- pred.GP(fit.GP3, x)
sqrt(mean((pred3$mu-fl(x, l=5))^2)) 
